...
- `xdg/default.nix` publishes Ghostty through the native Home Manager profile. Do not reintroduce the retired `ghostty-toolbox` launcher or host-copy activation hook.
